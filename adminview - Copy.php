...
<head>
  ...
  <style type="text/css">
   ...
   table td {border:solid 1px green; width:100px; word-wrap:break-word;}
 ...
 include ("dbconn.php");
  ...
  <div class="w3-sidebar w3-bar-block w3-card-2 w3-animate-left" style="display:none" id="mySidebar">
    ...
    if(!empty($_SESSION["adminname"]))
    {
      ...
      echo "<span class='page-scroll w3-bar-item w3-button' style='padding-left: 30px'> Hello " .$_SESSION['adminname']."</span><br>                         

      <a class='page-scroll w3-bar-item w3-button' href='logoutadmin.php' style='padding-left: 30px' >Logout</a><br>";
    }
    if(empty($_SESSION["adminname"]))
    {
      echo "<a class='page-scroll w3-bar-item' href='adminlogin.html' style='padding-left: 30px'>Log In</a><br>";
    }
    ?>
  </div>
  ...
  <div zclass="w3-main" id="main">
	...
	{
	echo "
	<div class='row' style='background-color:rgba(0,0,0,0.1);margin:auto;'>
	    <div class='row' style='padding-top:20px;padding-left:30px'>
		<div class='col-md-5 col-lg-5' style='border:3px solid #fed136;'>
			<input type='textbox' name='' value='".$row['firstname']."  ".$row['lastname']."' readonly style='color:#009688;padding-left:10px'>
			<input type='textbox' name='' value='".$row['contact']."' readonly style='color:#009688;font-weight:15px;font-size:19px;color:black;padding-left:10px'>
			<input type='textarea' name='' value='".$row['user_address']."' readonly style='color:black;padding-left:10px'>  
		</div>
		<div class='col-md-3 col-lg-3'>
			<label>ORDER ID</label> 
			<input type='textbox' name='' value='".$row['u_id']."' readonly style='color:#009688'><br>
			<label>Order created at </label>
			<input type='textbox' name='' value='".$row['orderdate']."' readonly style='font-weight:15px;font-size:15px;width:100%;color:red'>
		</div>
		<div class='col-md-2 col-lg-2'>
		
				<label>TOTAL:</label>
				<input type='textbox' name='' value='".$row['total']."' readonly style='color:black;font-weight:15px;font-size:15px'>
			        <br><br>
				<input type='button' value='".$row['status']."' style='color:red;'>
				<br>
		...
		<div class='col-md-2 col-lg-2'>
		 ...
		 <input type='button' value='".$row['accept_flag']."' style='color:#009688;margin-top:10px;width: 8em;  height: 4em;font-size:15px;background-color:white;'>
...
<div id="systemstatus" >
<button type="button home-button" id="button1" onclick='changeSystemToOn()'>System On</button>
 <button type="button contact-button" id="button2" onclick='changeSystemToOff()'>System Off</button>
</div>
        <div id="history" >
          <div class="row" style="float:right;padding-right: 20px">
            <input type="button" id="today" onclick='displaytoday()' value="Today">&nbsp
            <input type='button'  id='month' onclick='displaymonth()' value='Month'>&nbsp
            <input type='button'  id='year' onclick='displayyear()' value='Year'>&nbsp
          </div>
