...
<body>
  <div class="container">
    ...
    $api = new Instamojo\Instamojo('65198736be3512e993ebd6aaed957b95', '87e7fc950a8804c8449b8fb22e49d336','https://test.instamojo.com/api/1.1/');
	...
	$query = "UPDATE user_orders SET confirm_flag=1 ,status='paid' where u_id='$id'";
